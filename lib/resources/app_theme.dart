  ...
  static final lightTheme = ThemeData(
    ...
    extensions: <ThemeExtension<dynamic>>[
      AppColorsModel(
        ...
        onSurfaceContainer: Colors.white,
        mainTextColor: AppColors.darkColor,
        hintTextColor: AppColors.darkHintTextColor,
        bottomSearchButton: AppColors.lightGreyColor,
  ...
  static final darkTheme = ThemeData(
    ...
    extensions: <ThemeExtension<dynamic>>[
      AppColorsModel(
        ...
        onSurfaceContainer: AppColors.darkSlateBlue,
        mainTextColor: Colors.white,
        hintTextColor: AppColors.lavanderGrayColor,
        bottomSearchButton: AppColors.darkBlue,
        darkColor: AppColors.darkColor,
      ),
    ],
  );
}
