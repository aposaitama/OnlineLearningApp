...
//   List<UserModel> get userInfo => throw _privateConstructorUsedError;
...
//   @useResult
//   $Res call({List<UserModel> userInfo, HomeScreenStatus loadingStatus});
// }
...
//       {final List<UserModel> userInfo = const [],
...
//       const DeepCollectionEquality().hash(_userInfo), loadingStatus);
